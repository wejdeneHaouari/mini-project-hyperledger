...
class Vaccine extends State {
    ...
    constructor(obj) {
        super(Vaccine.getClass(), [obj.owner, obj.reference]);
    ...
    */
     ...
     */
    static createInstance(name, reference, issueDateTime, composition, owner ) {
        console.log("vaccine:createInstance:owner ", owner);
        return new Vaccine({name, reference, issueDateTime, composition , owner});
    }
